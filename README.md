...
To find out what the most talked about things are about each phone, I use topic modeling. Topic modeling extracts topics from texts - in my case, from a collection of tweets. 
